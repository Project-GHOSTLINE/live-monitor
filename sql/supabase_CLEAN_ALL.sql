-- ============================================
-- WW3 Monitor - CLEAN ALL (Delete EVERYTHING first)
-- ============================================
-- For Supabase PostgreSQL
-- Generated: 2026-02-28
--
-- This script DELETES ALL data from ALL tables, then inserts fresh data
-- ============================================

-- ============================================
-- PART 0: CLEAN EVERYTHING (in correct order)
-- ============================================
...
ALTER SEQUENCE feed_items_id_seq RESTART WITH 1;
ALTER SEQUENCE clusters_id_seq RESTART WITH 1;
ALTER SEQUENCE ingestion_logs_id_seq RESTART WITH 1;
ALTER SEQUENCE translation_cache_id_seq RESTART WITH 1;
...
('BBC News', 'https://feeds.bbci.co.uk/news/world/middle_east/rss.xml', 'mainstream', 5, 'en', 900, true),
('Reuters', 'https://www.reuters.com/rssfeed/worldNews', 'mainstream', 5, 'en', 900, true),
('AP News', 'https://rsshub.app/apnews/topics/apf-middleeast', 'mainstream', 5, 'en', 1200, true),
('Al Jazeera', 'https://www.aljazeera.com/xml/rss/all.xml', 'regional', 4, 'en', 900, true),
('Times of Israel', 'https://www.timesofisrael.com/feed/', 'regional', 4, 'en', 1200, true),
('Haaretz', 'https://www.haaretz.com/cmlink/1.628761', 'regional', 4, 'en', 1200, true),
('Jerusalem Post', 'https://www.jpost.com/rss/rssfeedsfrontpage.aspx', 'regional', 4, 'en', 1200, true),
('Middle East Eye', 'https://www.middleeasteye.net/rss', 'regional', 3, 'en', 1800, true),
('ReliefWeb', 'https://reliefweb.int/updates/rss.xml', 'humanitarian', 5, 'en', 1800, true),
('UN OCHA', 'https://www.unocha.org/rss.xml', 'official', 5, 'en', 3600, true),
('UN News', 'https://news.un.org/feed/subscribe/en/news/all/rss.xml', 'official', 5, 'en', 1800, true),
('IISS', 'https://www.iiss.org/blogs/rss/', 'mainstream', 5, 'en', 7200, true),
('Carnegie Endowment', 'https://carnegieendowment.org/feeds/all', 'mainstream', 4, 'en', 7200, true),
('Stratfor', 'https://worldview.stratfor.com/feeds/all', 'mainstream', 3, 'en', 7200, true),
('ISW', 'https://www.understandingwar.org/rss.xml', 'mainstream', 4, 'en', 7200, true);
...
-- ============================================
-- DONE! Expected: 15 sources + 30 feed items
-- ============================================
